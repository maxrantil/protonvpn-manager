...
### **BRANCH STRATEGY**
- `master`: **ONLY BRANCH** - Main development branch (simplified version)
- All feature branches are temporary and deleted after merge
- Enterprise version completely removed (October 2025)

**Note:** Clean, simple branch structure. All development happens on `master` via feature branches that are deleted after merge.
